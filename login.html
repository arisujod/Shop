...
(function() {
    ...
    <div class="login-container animate-up">
        ...
        <form method="POST">
            <input type="hidden" name="csrf_token" value="c8b7a65a779dce8177cc97a8408c6ada102e1c7eefe3410c1bf6bc283858aaa8">
...
<script src="assets/js/shield.js?v=1783963519"></script></body>
</html>
